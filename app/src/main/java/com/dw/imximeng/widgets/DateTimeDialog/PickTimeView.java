...
//                if (Integer.valueOf(sdf.format(cal.getTimeInMillis()))>=2017){
...
//            }
     ...
     * @param type
     */
    public void setViewType(int type,boolean isVisible) {
        ...
        if (isVisible) {
            mNpRight.setVisibility(VISIBLE);
        } else {
